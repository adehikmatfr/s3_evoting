...
$ql="SELECT * FROM pemilih where status='Belum Vote' and lv='L'";
$qp="SELECT * FROM pemilih where status='Sudah Voting' and lv='L'";
$ck=cekdb($ql);
$ck1=cekdb($qp);
$ck2=cekdb("SELECT * FROM pemilih where lv='L'");
$srt=$ck2/100;
$bagi=round($srt*$ck);
if($bagi<=0)
{
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Purbasora</h1>
          </div>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Suara</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
          ...
          <div class="row">
            ...
            <div class="card col-lg-12 shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Statistik Vouting Purbasora</h6>
                </div>
                <div class="card-body">

                    <canvas id="purba"></canvas>
...
$q="SELECT * FROM pemilih where status='Belum Vote' and lv='P'";
$p="SELECT * FROM pemilih where status='Sudah Voting' and lv='P'";
$ckc=cekdb($q);
$ck1c=cekdb($p);
$ck2c=cekdb("SELECT * FROM pemilih where lv='P'");
$srtc=$ck2c/100;
$bagic=round($srtc*$ckc);
if($bagic<=0)
{
  $bagic=100;
}
$suarasisac=(-$bagic+100);
$suaraisic=100-$suarasisac;
...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Citra Kirana</h1>
          </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?=$ck2c?></div>
                        </div>
                        <div class="col">
                          <div class="progress progress-sm mr-2">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="<?=$ck?>"></div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?=$ck1c?></div>
                        </div>
                        <div class="col">
                          <div class="progress progress-sm mr-2">
                            <div class="progress-bar bg-success" role="progressbar" <?= 'Style="width:'.$suaraisic.'%"' ?> aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?=$ckc?></div>
                        </div>
                        <div class="col">
                          <div class="progress progress-sm mr-2">
                            <div class="progress-bar bg-danger" role="progressbar" <?= 'Style="width:'.$suarasisac.'%"' ?> aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="row">
            ...
            <div class="card col-lg-12 shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Statistik Vouting Citra Kirana</h6>
                </div>
                <div class="card-body">

                    <canvas id="citra"></canvas>
...
<script>
    var ctx = document.getElementById("purba").getContext('2d');
...
<?php 
$x="SELECT * FROM kandidat Where jk='P' Order by no_kandidat asc";
$tm=tampil($x);
$tmm=tampil($x);
?>

<script>
    var ctx = document.getElementById("citra").getContext('2d');
    var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: [<?php foreach ($tm as $tm): ?>"<?=$tm['nama']?>",<?php endforeach; ?>],
